---
name: outreach-law-engine
description: Apply contact permission, suppression, DNC, sensitive-category, age/minor, channel, and jurisdiction constraints to outreach. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
# Outreach Compliance Engine v2

Apply contact permission, suppression, DNC, sensitive-category, age/minor, channel, and jurisdiction constraints to outreach.
...
- Compliance is a gate before execution, not a post-send check.
- Use current consent/DNC/compliance records and authoritative rules.
- Block or require human review when eligibility is uncertain.
...
---
*KHG Outreach Compliance Engine — direct-first, entity-isolated, evidence-verified.*
