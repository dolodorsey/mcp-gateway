---
name: app-visionary
description: Define and evolve KHG digital products using live user, provider, conversion, operational, and technical evidence. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Define and evolve KHG digital products using live user, provider, conversion, operational, and technical evidence.
...
- Resolve the exact app/entity and dedicated backend.
- Prefer direct product/backend integrations over generic workflow middleware.
- Separate product roadmap, user roles, provider roles, and monetization logic.
...
---
*KHG App Visionary — direct-first, entity-isolated, evidence-verified.*
