...
description: Produce current entity-specific operational, marketing, sales, and growth reporting from authoritative data. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Produce current entity-specific operational, marketing, sales, and growth reporting from authoritative data.
...
- Query live source systems directly.
- Separate actuals from estimates and stale snapshots.
- Never aggregate brands in a way that destroys attribution.
...
---
*KHG Analytics & Reporting — direct-first, entity-isolated, evidence-verified.*
