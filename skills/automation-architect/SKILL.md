...
description: Design reliable direct integrations, schedules, condition checks, and workers using the fewest necessary systems. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
# Direct Systems Architect v2

Design reliable direct integrations, schedules, condition checks, and workers using the fewest necessary systems.
...
- Prefer native database triggers/cron, Edge Functions, direct APIs, connected tools, and small purpose-built workers.
- Avoid intermediary workflow layers unless the user explicitly requests one and there is a real gap.
- Build idempotency, retries, rate limits, audit logs, secrets isolation, and verification into the system.
...
---
*KHG Direct Systems Architect — direct-first, entity-isolated, evidence-verified.*
