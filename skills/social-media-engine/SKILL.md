...
description: Plan, source, create, approve, publish, engage, and measure social media for one exact entity. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
- Keep account identities, audiences, campaigns, and engagement histories separate.
...
---
*KHG Social Media Engine — direct-first, entity-isolated, evidence-verified.*
