...
description: Manage briefs, assets, production, revisions, approvals, exports, and delivery for an exact brand/campaign. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
# Creative Production v2

Manage briefs, assets, production, revisions, approvals, exports, and delivery for an exact brand/campaign.
...
- Use current asset sources and rights metadata.
- Keep source files and deliverables attached to the correct entity.
- Do not let old automation/export conventions dictate the current workflow.
...
---
*KHG Creative Production — direct-first, entity-isolated, evidence-verified.*
