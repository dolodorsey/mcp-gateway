...
description: Define and apply the exact entity’s voice, messaging rules, vocabulary, audience framing, and campaign tone. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
# Brand Voice Engine v2

Define and apply the exact entity’s voice, messaging rules, vocabulary, audience framing, and campaign tone.
...
- Never make every entity sound like the founder or parent brand.
- Ground voice in approved assets, existing copy, audience, and offer.
- Keep cross-brand voice borrowing explicit and limited.
...
---
*KHG Brand Voice Engine — direct-first, entity-isolated, evidence-verified.*
