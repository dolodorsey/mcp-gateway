---
name: grant-strategy
description: Research, qualify, prepare, submit, and track grants for the exact eligible legal entity/program. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Research, qualify, prepare, submit, and track grants for the exact eligible legal entity/program.
...
- Verify eligibility and deadlines from authoritative sources.
- Keep legal entity, program, budget, and attachments exact.
- Use direct application portals/document stores and track submission evidence.
...
---
*KHG Grant Strategy — direct-first, entity-isolated, evidence-verified.*
