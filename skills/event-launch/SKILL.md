---
name: event-launch
description: Launch one exact event from announcement through ticketing, sponsors, vendors, production, day-of operations, and post-event retention. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Launch one exact event from announcement through ticketing, sponsors, vendors, production, day-of operations, and post-event retention.
...
- Treat each event as an isolated entity/campaign.
- Read live event dates, offers, forms, ticket/booking routes, owners, and status before execution.
- Use direct provider APIs, Supabase functions/RPCs, browser, or terminal as appropriate.
...
---
*KHG Event Launch — direct-first, entity-isolated, evidence-verified.*
