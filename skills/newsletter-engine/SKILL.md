...
description: Plan, draft, segment, approve, send, and measure newsletters for one exact brand or audience. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Plan, draft, segment, approve, send, and measure newsletters for one exact brand or audience.
...
- Resolve exact sender, consent/suppression, audience, offer, and cadence.
- Use direct email provider/current email rails.
- Never merge subscriber lists or sender identities by default.
...
---
*KHG Newsletter Engine — direct-first, entity-isolated, evidence-verified.*
