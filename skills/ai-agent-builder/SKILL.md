...
description: Design focused KHG agents that operate against current systems with narrow permissions, clear evidence, and measurable outcomes. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Design focused KHG agents that operate against current systems with narrow permissions, clear evidence, and measurable outcomes.
...
- Default to direct connected tools/APIs/RPCs/terminal/browser.
- Do not add orchestration middleware unless explicitly requested and materially necessary.
- Every agent must declare source of truth, write boundary, approval gate, failure mode, and verification test.
...
---
*KHG AI Agent Builder — direct-first, entity-isolated, evidence-verified.*
