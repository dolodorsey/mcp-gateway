---
name: sop-generator
description: Turn current verified operating processes into concise SOPs, checklists, roles, controls, and escalation paths. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Turn current verified operating processes into concise SOPs, checklists, roles, controls, and escalation paths.
...
- Audit the live system before documenting it.
- Mark legacy steps as retired instead of preserving them.
- Prefer the fewest authoritative tools and one source of truth per process.
...
---
*KHG SOP Generator — direct-first, entity-isolated, evidence-verified.*
