---
name: financial-ops
description: Operate entity-level budgets, invoices, revenue, expenses, cash controls, reporting, and financial follow-up. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Operate entity-level budgets, invoices, revenue, expenses, cash controls, reporting, and financial follow-up.
...
- Keep legal entity and brand attribution intact.
- Use authoritative accounting/payment/database sources directly.
- Never infer financial truth from stale dashboards or old automation reports.
...
---
*KHG Financial Operations — direct-first, entity-isolated, evidence-verified.*
