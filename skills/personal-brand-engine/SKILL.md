...
description: Operate the founder/personal brand as its own editorial and relationship system while selectively cross-promoting enterprise work. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
# Personal Brand Engine v2

Operate the founder/personal brand as its own editorial and relationship system while selectively cross-promoting enterprise work.
...
- Keep personal-brand audience and conversion goals distinct from company pages.
- Use direct social/content/CRM tools.
- Cross-promotion must preserve the destination brand’s attribution.
...
---
*KHG Personal Brand Engine — direct-first, entity-isolated, evidence-verified.*
