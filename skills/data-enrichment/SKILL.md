...
description: Enrich public/business lead records with defensible source evidence and current contact/company context. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Enrich public/business lead records with defensible source evidence and current contact/company context.
...
- Start from an exact entity-attributed lead or approved source inventory.
- Use authorized APIs, public sources, browser, or direct lookup tools.
- Never overwrite known data with weaker enrichment or infer sensitive traits.
...
---
*KHG Data Enrichment — direct-first, entity-isolated, evidence-verified.*
