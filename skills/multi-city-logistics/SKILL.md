...
description: Coordinate venues, vendors, travel, inventory, staffing, permits, schedules, and contingencies across cities while preserving local/entity ownership. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
# Multi-City Logistics v2

Coordinate venues, vendors, travel, inventory, staffing, permits, schedules, and contingencies across cities while preserving local/entity ownership.
...
- Treat each market/date as an explicit operating unit.
- Use direct booking/vendor/calendar/logistics systems.
- Maintain one current master status with sourced local details.
...
---
*KHG Multi-City Logistics — direct-first, entity-isolated, evidence-verified.*
