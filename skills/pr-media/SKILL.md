---
name: pr-media
description: Build press lists, pitches, media kits, press releases, interview prep, coverage tracking, and brand-specific media relationships. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Build press lists, pitches, media kits, press releases, interview prep, coverage tracking, and brand-specific media relationships.
...
- Resolve the exact entity/campaign before media work.
- Use public media/contact sources and connected communication tools directly.
- Track outreach and coverage in the entity’s current CRM/BOH records; do not create a shared enterprise press list by default.
...
---
*KHG PR & Media — direct-first, entity-isolated, evidence-verified.*
