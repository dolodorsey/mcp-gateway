---
name: crm-pipeline
description: Operate brand-isolated prospect, opportunity, follow-up, and conversion pipelines. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Operate brand-isolated prospect, opportunity, follow-up, and conversion pipelines.
...
- Use KOLLECTIVE BOH and the exact entity’s live backend as source of truth.
- Every lead relationship must retain exact entity attribution and role/archetype.
- Use direct CRM/API/database actions; do not introduce a generic external workflow router.
...
---
*KHG CRM Pipeline — direct-first, entity-isolated, evidence-verified.*
