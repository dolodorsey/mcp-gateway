---
name: sponsor-pitch
description: Research, qualify, pitch, follow up with, and close sponsors for an exact event, brand, program, or property. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Research, qualify, pitch, follow up with, and close sponsors for an exact event, brand, program, or property.
...
- Resolve exact sponsorship property first.
- Do not reuse another entity’s sponsor list without separate qualification.
- Use direct email/CRM/connected tools and store outcomes under the exact entity.
...
---
*KHG Sponsor Pitch — direct-first, entity-isolated, evidence-verified.*
