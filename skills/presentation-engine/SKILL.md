...
description: Build decks and presentations grounded in current entity facts, assets, audience, objective, and source evidence. Direct-first KHG skill. Resolve the exact entity and current backend before execution; preserve brand/entity isolation and verify results.
metadata:
  version: 2.0.0
...
Build decks and presentations grounded in current entity facts, assets, audience, objective, and source evidence.
...
- Use current BOH/company context and approved assets.
- Do not copy stale completion reports as current truth.
- Keep financial, legal, event, and brand claims verifiable.
...
---
*KHG Presentation Engine — direct-first, entity-isolated, evidence-verified.*
